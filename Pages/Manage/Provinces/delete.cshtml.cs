...
namespace BonayogDianaMae.Midterm.Pages.Manage.Products
{
    public class Delete : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            var role = _context?.Provinces?.FirstOrDefault(a => a.Id == View.Id);

            if (role != null)
            {
                _context?.Provinces?.Remove(role);
        ...
        public class ViewModel : ProvincesLogin
        {
